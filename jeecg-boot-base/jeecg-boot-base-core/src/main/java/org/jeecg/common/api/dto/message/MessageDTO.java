 ...
 */
@Data
@ApiModel(value="钉钉消息对象", description="激励金web测试")
public class MessageDTO implements Serializable {
     ...
     * 发送人(用户登录账户)
     */
    @ApiModelProperty(value = "发送人(用户登录账户)")
    protected String fromUser;

    /**
     * 发送给(用户登录账户)
     */
    @ApiModelProperty(value = "发送给(用户登录账户)")
    protected String toUser;

    /**
     * 发送给所有人
     */
    @ApiModelProperty(value = "发送给所有人")
     ...
     * 消息类型 1:消息  2:系统消息
     */
    @ApiModelProperty(value = "消息类型 1:消息  2:系统消息")
