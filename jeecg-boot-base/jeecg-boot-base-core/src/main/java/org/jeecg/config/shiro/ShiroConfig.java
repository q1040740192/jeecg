...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager) {
        ...
        // 配置不会被拦截的链接 顺序判断
//        filterChainDefinitionMap.put("/bonus/web/login", "anon");//激励金web登录接口排除
        filterChainDefinitionMap.put("/bonus/web/**", "anon");//开发环境用上面的！
        filterChainDefinitionMap.put("/bonus/h5Api/**", "anon");//激励金h5接口排除
